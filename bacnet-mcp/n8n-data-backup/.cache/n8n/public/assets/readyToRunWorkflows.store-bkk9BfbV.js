import { a3 as defineStore, ah as useFoldersStore, a5 as useWorkflowsStore, d5 as usePostHog, v as useSettingsStore, aR as useLocalStorage, x as computed, fd as TEMPLATE_ONBOARDING_EXPERIMENT, c as useI18n, aA as useTelemetry, a8 as STORES, b6 as useCloudPlanStore, fe as BATCH_11AUG_EXPERIMENT } from "./index-DJu2gb_4.js";
...
const useReadyToRunWorkflowsStore = defineStore(
  ...
  () => {
    ...
    const isFeatureEnabled = computed(() => {
      return posthogStore.getVariant(BATCH_11AUG_EXPERIMENT.name) === BATCH_11AUG_EXPERIMENT.variantReadyToRun && cloudPlanStore.userIsTrialing;
    });
