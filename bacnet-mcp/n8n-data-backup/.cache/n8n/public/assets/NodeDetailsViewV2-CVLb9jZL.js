import { d as defineComponent, x as computed, c as useI18n, h as createElementBlock, g as openBlock, j as createBaseVNode, i as createVNode, n as normalizeClass, e as createBlock, f as createCommentVNode, bT as NodeIcon, at as InlineRename, l as unref, a2 as N8nLink, w as withCtx, p as N8nText, k as createTextVNode, t as toDisplayString, N as N8nIcon, $ as N8nTooltip, a0 as _sfc_main$3, _ as _export_sfc, r as ref, he as LOCAL_STORAGE_NDV_PANEL_WIDTH, hf as toValue, g2 as useElementSize, ab as watch, bW as toRef, dc as jsonParse, f$ as Draggable, hg as FontAwesomeIcon, aP as useNDVStore, bF as useNodeHelpers, el as storeToRefs, bD as usePinnedData, bK as useNodeTypesStore, T as useUIStore, a5 as useWorkflowsStore, cA as useDeviceSupport, cd as useStyles, as as useTemplateRef, hh as useNodeDocsUrl, gV as getNodeOutputs, bs as NodeConnectionTypes, bL as START_NODE_TYPE, gW as EXECUTABLE_TRIGGER_NODE_TYPES, aT as STICKY_NODE_TYPE, cq as useKeybindings, o as onMounted, gY as dataPinningEventBus, I as onBeforeUnmount, P as normalizeStyle, hi as getNodeIconSource, g_ as InputPanel, gZ as NodeSettings, Q as createEventBus, cc as N8nResizeWrapper, g$ as APP_MODALS_ELEMENT_ID, hj as Teleport, aA as useTelemetry, aC as useMessage, aD as MODAL_CONFIRM, bg as useExternalHooks } from "./index-DJu2gb_4.js";
import { _ as __unplugin_components_0, T as TriggerPanel, O as OutputPanel } from "./TriggerPanel-CRLzika6.js";
import { u as useWorkflowActivate } from "./useWorkflowActivate-G9wdzjX4.js";
import "./RunDataParsedAiContent-DNxDdAFA.js";
import "./VueMarkdown-BXoAxQ2V.js";
import "./ConsumedTokensDetails.vue_vue_type_script_setup_true_lang-BNkO3XxQ.js";
import "./NodeView-CFpi2pKv.js";
import "./global-link-actions-BLMbNlby.js";
import "./useExecutionDebugging-D0j03ZAv.js";
import "./useBeforeUnload-hEveYtYY.js";
import "./canvas-BAegJxph.js";
import "./readyToRunWorkflows.store-bkk9BfbV.js";
import "./InfoAccordion-MlURVMcX.js";
          ...
          createBaseVNode("div", {
            ...
            createBaseVNode("main", {
              ...
              hasInputPanel.value ? (openBlock(), createElementBlock("div", {
                ...
                }, null, 8, ["workflow", "can-link-runs", "run-index", "linked-runs", "active-node-name", "current-node-name", "push-ref", "read-only", "is-production-execution-preview", "is-pane-active", "display-mode", "class", "is-mapping-onboarded", "focused-mappable-input"])) : createCommentVNode("", true)
...
const backdrop = "_backdrop_vt26y_123";
const dialog = "_dialog_vt26y_133";
const container = "_container_vt26y_147";
const main = "_main_vt26y_158";
const column = "_column_vt26y_165";
const input = "_input_vt26y_178";
const output = "_output_vt26y_179";
const dataColumn = "_dataColumn_vt26y_183";
const header = "_header_vt26y_187";
const settings = "_settings_vt26y_201";
const draggable = "_draggable_vt26y_206";
const style0 = {
  backdrop,
  dialog,
  container,
