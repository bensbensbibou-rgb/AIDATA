import { d as defineComponent, e as createBlock, g as openBlock, f$ as Draggable, n as normalizeClass, w as withCtx, j as createBaseVNode, h as createElementBlock, f as createCommentVNode, i as createVNode, N as N8nIcon, _ as _export_sfc, cf as useThrottleFn, aP as useNDVStore, T as useUIStore, r as ref, fs as useSlots, o as onMounted, x as computed, cr as ndvEventBus, I as onBeforeUnmount, ab as watch, gT as MAIN_NODE_PANEL_WIDTH, b7 as useStorage, gU as LOCAL_STORAGE_MAIN_PANEL_RELATIVE_WIDTH, l as unref, P as normalizeStyle, J as renderSlot, cc as N8nResizeWrapper, K as nextTick, bF as useNodeHelpers, el as storeToRefs, bD as usePinnedData, bK as useNodeTypesStore, a5 as useWorkflowsStore, cA as useDeviceSupport, cd as useStyles, gV as getNodeOutputs, bs as NodeConnectionTypes, bL as START_NODE_TYPE, gW as EXECUTABLE_TRIGGER_NODE_TYPES, aT as STICKY_NODE_TYPE, gX as BASE_NODE_SURVEY_URL, gY as dataPinningEventBus, O as resolveComponent, $ as N8nTooltip, p as N8nText, k as createTextVNode, t as toDisplayString, c as useI18n, bi as createSlots, gZ as NodeSettings, Q as createEventBus, g_ as InputPanel, g$ as APP_MODALS_ELEMENT_ID, aA as useTelemetry, aC as useMessage, aD as MODAL_CONFIRM, dc as jsonParse, bg as useExternalHooks } from "./index-DJu2gb_4.js";
import { _ as __unplugin_components_0, O as OutputPanel, T as TriggerPanel } from "./TriggerPanel-CRLzika6.js";
            ...
            (openBlock(), createBlock(NDVDraggablePanels, {
              ...
              showTriggerPanel.value || !isTriggerNode.value ? {
                ...
                fn: withCtx(() => [
                  ...
                  }, null, 8, ["workflow", "can-link-runs", "run-index", "linked-runs", "active-node-name", "current-node-name", "push-ref", "read-only", "is-production-execution-preview", "is-pane-active", "display-mode", "is-mapping-onboarded", "focused-mappable-input"])) : createCommentVNode("", true)
                ]),
                key: "0"
              } : void 0
