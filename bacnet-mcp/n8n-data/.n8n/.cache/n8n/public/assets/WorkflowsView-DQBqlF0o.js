import { d as defineComponent, a6 as useRoute, b as useRouter, ah as useFoldersStore, r as ref, x as computed, c as useI18n, ar as ProjectTypes, V as VIEWS, O as resolveComponent, h as createElementBlock, g as openBlock, i as createVNode, w as withCtx, s as N8nCard, n as normalizeClass, j as createBaseVNode, f as createCommentVNode, e as createBlock, fS as ProjectCardBadge, l as unref, aJ as ResourceType, e5 as N8nActionToggle, bS as withModifiers, p as N8nText, k as createTextVNode, t as toDisplayString, eA as _sfc_main$5, m as N8nHeading, aw as N8nBadge, N as N8nIcon, _ as _export_sfc, a as useToast, v as useSettingsStore, T as useUIStore, u as useUsersStore, a5 as useWorkflowsStore, ag as useProjectsStore, an as getResourcePermissions, fJ as dateFormat, aV as withDirectives, aW as vShow, az as WORKFLOW_SHARE_MODAL_KEY, aA as useTelemetry, aI as DUPLICATE_MODAL_KEY, aC as useMessage, aD as MODAL_CONFIRM, aK as PROJECT_MOVE_RESOURCE_MODAL, fT as FOLDER_NAME_ILLEGAL_CHARACTERS_REGEX, fU as ILLEGAL_FOLDER_CHARACTERS, fV as FOLDER_NAME_ONLY_DOTS_REGEX, fW as FOLDER_NAME_MAX_LENGTH, a3 as defineStore, d5 as usePostHog, b6 as useCloudPlanStore, be as useTemplatesStore, b7 as useStorage, fX as LOCAL_STORAGE_EXPERIMENTAL_DISMISSED_SUGGESTED_WORKFLOWS, dc as jsonParse, ab as watch, fd as TEMPLATE_ONBOARDING_EXPERIMENT, a8 as STORES, dk as N8nCallout, a2 as N8nLink, J as renderSlot, af as useSourceControlStore, R as useTagsStore, eQ as useUsageStore, fY as useInsightsStore, aj as useDocumentTitle, S as useDebounce, aq as EnterpriseEditionFeature, fZ as isExtraTemplateLinksExperimentEnabled, o as onMounted, Q as createEventBus, I as onBeforeUnmount, L as debounce, f_ as PROJECT_ROOT, as as useTemplateRef, bi as createSlots, $ as N8nTooltip, q as N8nButton, dQ as N8nActionBox, dZ as N8nInputLabel, av as _sfc_main$7, e0 as N8nSelect, F as Fragment, y as renderList, e1 as _sfc_main$8, eO as N8nCheckbox, f$ as Draggable, dC as N8nLoading, at as InlineRename, g0 as DEFAULT_WORKFLOW_PAGE_SIZE, bm as trackTemplatesClick, bn as TemplateClickSource, dn as getEasyAiWorkflowJson, eS as COMMUNITY_PLUS_ENROLLMENT_MODAL } from "./index-DJu2gb_4.js";
import { _ as _sfc_main$6 } from "./EmptySharedSectionActionBox.vue_vue_type_script_setup_true_lang-BO3rV-x9.js";
import { B as Breadcrumbs, W as WorkflowActivator, _ as __unplugin_components_0 } from "./WorkflowActivator-D35S71ij.js";
...
import { T as Tags } from "./Tags-BjFupN4S.js";
import { u as useProjectPages } from "./useProjectPages-CFEdc5ap.js";
import { u as useAITemplatesStarterCollectionStore, a as useReadyToRunWorkflowsStore } from "./readyToRunWorkflows.store-bkk9BfbV.js";
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_TimeAgo = _sfc_main$5;
...
const cardLink = "_cardLink_ycbf3_123";
const cardHeading = "_cardHeading_ycbf3_133";
const cardHeadingArchived = "_cardHeadingArchived_ycbf3_142";
const cardDescription = "_cardDescription_ycbf3_146";
const cardTags = "_cardTags_ycbf3_153";
const cardActions = "_cardActions_ycbf3_158";
const cardBadge = "_cardBadge_ycbf3_168";
const cardArchived = "_cardArchived_ycbf3_179";
const breadcrumbs = "_breadcrumbs_ycbf3_197";
const style0$3 = {
  cardLink,
  cardHeading,
  cardHeadingArchived,
  ...
  cardActions,
  cardBadge,
  "with-breadcrumbs": "_with-breadcrumbs_ycbf3_172",
  cardArchived,
  breadcrumbs
};
const cssModules$3 = {
...
const WorkflowCard = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__cssModules", cssModules$3]]);
...
const SuggestedWorkflowCard = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__cssModules", cssModules$2]]);
const style0$1 = {
...
const SuggestedWorkflows = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__cssModules", cssModules$1]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_EmptySharedSectionActionBox = _sfc_main$6;
      ...
      return openBlock(), createBlock(ResourcesListLayout, {
        ...
        "onUpdate:filters": [
          _cache[7] || (_cache[7] = ($event) => filters.value = $event),
          onFiltersUpdated
        ],
        ...
        callout: withCtx(() => [
            ...
            trailingContent: withCtx(() => [
              createBaseVNode("div", {
                ...
                createVNode(unref(N8nButton), {
                  ...
                  size: "small",
                  type: "secondary",
                  onClick: _cache[1] || (_cache[1] = ($event) => openAIWorkflow("callout"))
                }, {
                  default: withCtx(() => [
          ...
          showReadyToRunWorkflowsCallout.value ? (openBlock(), createBlock(_component_N8nCallout, {
            ...
            trailingContent: withCtx(() => [
              createBaseVNode("div", {
                ...
                createVNode(unref(N8nButton), {
                  ...
                  size: "small",
                  type: "secondary",
                  onClick: _cache[2] || (_cache[2] = ($event) => handleCreateReadyToRunWorkflows("callout"))
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString(unref(i18n).baseText("workflows.readyToRunWorkflows.cta")), 1)
                  ]),
                  _: 1
                }),
                createVNode(unref(N8nIcon), {
            ...
            default: withCtx(() => [
              createTextVNode(toDisplayString(unref(i18n).baseText("workflows.readyToRunWorkflows.callout")) + " ", 1)
            ]),
            _: 1
          }, 8, ["class"])) : createCommentVNode("", true)
        ]),
          ...
          data.resourceType === "folder" ? (openBlock(), createBlock(Draggable, {
            ...
            default: withCtx(() => [
              createVNode(WorkflowCard, {
                ...
                onMouseenter: _cache[3] || (_cache[3] = ($event) => isDragging.value ? unref(folderHelpers).resetDropTarget() : {})
          ...
          unref(projectPages).isSharedSubPage && personalProject.value ? (openBlock(), createBlock(_component_EmptySharedSectionActionBox, {
            ...
            !readOnlyEnv.value && projectPermissions.value.workflow.create ? (openBlock(), createElementBlock("div", {
              ...
              showAIStarterCollectionCallout.value ? (openBlock(), createBlock(unref(N8nCard), {
                ...
                onClick: _cache[4] || (_cache[4] = ($event) => createAIStarterWorkflows("card"))
              }, {
                default: withCtx(() => [
                  createBaseVNode("div", {
                    class: normalizeClass(_ctx.$style.emptyStateCardContent)
                ...
                hoverable: "",
                "data-test-id": "easy-ai-workflow-card",
                onClick: _cache[5] || (_cache[5] = ($event) => openAIWorkflow("empty"))
              }, {
                default: withCtx(() => [
                  createBaseVNode("div", {
                    class: normalizeClass(_ctx.$style.emptyStateCardContent)
              ...
              showReadyToRunWorkflowsCallout.value ? (openBlock(), createBlock(unref(N8nCard), {
                ...
                onClick: _cache[6] || (_cache[6] = ($event) => handleCreateReadyToRunWorkflows("card"))
              }, {
                default: withCtx(() => [
                  createBaseVNode("div", {
                    class: normalizeClass(_ctx.$style.emptyStateCardContent)
                    ...
                    createVNode(unref(N8nText), {
                      ...
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(i18n).baseText("workflows.readyToRunWorkflows.card")), 1)
                      ]),
                      _: 1
                    })
                  ], 2)
