import { d as defineComponent, ac as useCssModule, x as computed, er as getCurrentInstance, h as createElementBlock, f as createCommentVNode, g as openBlock, F as Fragment, y as renderList, n as normalizeClass, l as unref, J as renderSlot, j as createBaseVNode, t as toDisplayString, e as createBlock, bi as createSlots, w as withCtx, D as mergeProps, _ as _export_sfc, as as useTemplateRef, r as ref, aP as useNDVStore, a5 as useWorkflowsStore, dA as useExecutionHelpers, el as storeToRefs, o as onMounted, ab as watch, aV as withDirectives, i as createVNode, a0 as _sfc_main$2, aW as vShow, c as useI18n, $ as N8nTooltip, k as createTextVNode, cH as InfoTip, f$ as Draggable, gB as __unplugin_components_0, N as N8nIcon, gC as MappingPill, gD as shorten, a1 as I18nT, gE as getPairedItemId, gF as getMappedExpression, bg as useExternalHooks, aA as useTelemetry } from "./index-DJu2gb_4.js";
const _hoisted_1$1 = {
  key: 0,
  class: "n8n-tree"
};
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(tableData.value.data, (_, index1) => {
              return openBlock(), createElementBlock("tr", {
                ...
                tableData.value.metadata.hasExecutionIds ? (openBlock(), createElementBlock("td", {
                  ...
                  tableData.value.metadata.data[index1] ? (openBlock(), createBlock(unref(N8nTooltip), {
                    key: 0,
