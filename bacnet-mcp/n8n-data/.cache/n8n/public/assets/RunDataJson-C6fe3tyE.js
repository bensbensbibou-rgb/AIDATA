const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-Bf40hCdJ.js","assets/index-DJu2gb_4.js","assets/index-B09aakje.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-B2jW3_UG.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, aP as useNDVStore, r as ref, g2 as useElementSize, x as computed, gG as executionDataToJson, h as createElementBlock, g as openBlock, e as createBlock, i as createVNode, w as withCtx, f as createCommentVNode, l as unref, dj as defineAsyncComponent, di as Suspense, gH as VueJsonPretty, gB as __unplugin_components_0, n as normalizeClass, gC as MappingPill, f$ as Draggable, aL as __vitePreload, gD as shorten, gF as getMappedExpression, bg as useExternalHooks, aA as useTelemetry, gI as isString, gJ as nonExistingJsonPath, _ as _export_sfc } from "./index-DJu2gb_4.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-Bf40hCdJ.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
