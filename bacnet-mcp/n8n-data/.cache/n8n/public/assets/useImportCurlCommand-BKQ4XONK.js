import { gu as process$1, gv as requirePathBrowserify, gw as require$$0, bN as getDefaultExportFromCjs, gx as Buffer, a as useToast, l as unref, eq as assert, gy as CURL_IMPORT_NOT_SUPPORTED_PROTOCOLS, gz as importCurlEventBus, gA as CURL_IMPORT_NODES_PROTOCOLS, c as useI18n, bu as get } from "./index-DJu2gb_4.js";
        ...
        static init(moduleOptions) {
          ...
          return initPromise = new Promise((resolveInitPromise) => {
            ...
            if (ENVIRONMENT_IS_NODE) {
              var fs = require$$0;
              var nodePath = requirePathBrowserify();
...
const getContentTypeHeader = (headers) => {
  return get(headers, CONTENT_TYPE_KEY) ?? void 0;
};
...
const jsonBodyToNodeParameters = (body2 = {}) => {
  if (typeof body2 === "string") {
    const parameters = new URLSearchParams(body2);
    return [...parameters.entries()].map((parameter) => {
      return toKeyValueArray(parameter);
    });
  }
  return keyValueBodyToNodeParameters(body2);
};
