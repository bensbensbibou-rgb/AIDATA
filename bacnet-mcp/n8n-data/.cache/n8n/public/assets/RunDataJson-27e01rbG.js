const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-Pq9pGbtg.js","assets/index-CRQJ7x6N.js","assets/index-C6NR226r.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-B2jW3_UG.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, aY as useNDVStore, r as ref, g9 as useElementSize, x as computed, gY as executionDataToJson, h as createElementBlock, g as openBlock, e as createBlock, i as createVNode, w as withCtx, f as createCommentVNode, l as unref, dl as defineAsyncComponent, dk as Suspense, gZ as VueJsonPretty, gT as __unplugin_components_0, n as normalizeClass, gU as MappingPill, g5 as Draggable, aU as __vitePreload, gV as shorten, gX as getMappedExpression, bn as useExternalHooks, ap as useTelemetry, g_ as isString, g$ as nonExistingJsonPath, _ as _export_sfc } from "./index-CRQJ7x6N.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-Pq9pGbtg.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
