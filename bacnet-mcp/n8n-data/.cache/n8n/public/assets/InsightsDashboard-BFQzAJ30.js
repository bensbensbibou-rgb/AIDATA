const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-ol8lMMqv.js","assets/index-DJu2gb_4.js","assets/index-B09aakje.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-D9mguvTz.js","assets/chartjs.utils-BW1BHqON.js","assets/InsightsSummary-DuEa77Gq.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-BpQz0FGO.js","assets/InsightsChartFailed-B9pKFsLn.js","assets/InsightsChartFailureRate-BWblqNp_.js","assets/InsightsChartTimeSaved-Bsjt89_E.js","assets/InsightsChartAverageRuntime-BgEppbrD.js","assets/InsightsTableWorkflows-CKfAgykg.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, e8 as useModel, fY as useInsightsStore, r as ref, gq as UNLICENSED_TIME_RANGE, g4 as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, y as renderList, l as unref, e1 as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, e0 as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, gr as ElDialog, am as usePageRedirectionHelper, _ as _export_sfc, a6 as useRoute, gs as INSIGHT_TYPES, dj as defineAsyncComponent, ab as watch, o as onMounted, aj as useDocumentTitle, m as N8nHeading, n as normalizeClass, dB as _sfc_main$4, b$ as resolveDynamicComponent, aA as useTelemetry, gt as TELEMETRY_TIME_RANGE, aL as __vitePreload } from "./index-DJu2gb_4.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-ol8lMMqv.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-D9mguvTz.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-B9pKFsLn.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-BWblqNp_.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-Bsjt89_E.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-BgEppbrD.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-CKfAgykg.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
