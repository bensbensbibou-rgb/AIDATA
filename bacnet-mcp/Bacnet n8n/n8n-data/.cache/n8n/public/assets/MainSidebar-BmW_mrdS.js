import { d as defineComponent, r as ref, e as createBlock, g as openBlock, w as withCtx, i as createVNode, l as unref, b5 as ElSubMenu, n as normalizeClass, h as createElementBlock, F as Fragment, A as renderList, b6 as _sfc_main$6, b7 as ElMenuItem, f as createCommentVNode, k as createTextVNode, Q as renderSlot, N as N8nIcon, p as N8nText, t as toDisplayString, K as mergeProps, b8 as withKeys, b9 as ElMenu, _ as _export_sfc, ba as get, aj as useSourceControlStore, au as useProjectsStore, aa as useRoute, b as useRouter, x as computed, aD as hasPermission, aB as getResourcePermissions, U as normalizeStyle, j as createBaseVNode, a4 as Tooltip, q as N8nButton, c as useI18n, a7 as defineStore, bb as useCloudPlanStore, at as useRootStore, bc as useStorage, bd as DateTime, ac as STORES, ap as useTelemetry, v as useSettingsStore, a as useToast, be as sortByProperty, V as VIEWS, bf as updatedIconSet, aA as usePageRedirectionHelper, u as useUsersStore, b1 as onBeforeMount, bg as N8nMenuItem, bh as useDebugInfo, bi as useVersionsStore, Z as useUIStore, C as N8nLink, bj as VERSIONS_MODAL_KEY, bk as useTemplatesStore, a9 as useWorkflowsStore, bl as usePersonalizedTemplatesV2Store, Y as useDebounce, bm as RELEASE_NOTES_URL, o as onMounted, bn as useExternalHooks, R as nextTick, P as onBeforeUnmount, bo as onClickOutside, T as resolveComponent, a6 as I18nT, a5 as _sfc_main$7, bp as createSlots, G as N8nAvatar, aM as N8nActionDropdown, bq as N8nMenu, br as WHATS_NEW_MODAL_KEY, bs as ABOUT_MODAL_KEY, bt as EXPERIMENT_TEMPLATE_RECO_V2_KEY, bu as trackTemplatesClick, bv as TemplateClickSource } from "./index-CRQJ7x6N.js";
import { L as Logo } from "./Logo-BWRzR7Wn.js";
...
const __unplugin_components_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__cssModules", cssModules$2], ["__scopeId", "data-v-524ab596"]]);
  ...
  setup(__props) {
    ...
    const mainMenuItems = computed(() => [
      ...
      },
      {
        ...
        label: i18n.baseText("mainSidebar.templates"),
        position: "bottom",
        available: settingsStore.isTemplatesEnabled && templatesStore.hasCustomTemplatesHost && !personalizedTemplatesV2Store.isFeatureEnabled(),
