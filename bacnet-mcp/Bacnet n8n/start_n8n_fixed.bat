@echo off
echo ========================================
echo DEMARRAGE N8N AVEC VARIABLES D'ENVIRONNEMENT
echo ========================================
...
start "n8n avec config" cmd /k "n8n start --port 5678 --user-folder ./n8n-data"
...
echo.
echo Task Runners: ENABLES (plus d'avertissement)
echo.
pause
